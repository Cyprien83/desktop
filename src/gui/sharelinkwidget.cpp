...
void ShareLinkWidget::setupUiOptions(){
    ...
    connect(animation, &QAbstractAnimation::finished, this, &ShareLinkWidget::resizeRequested);
...
void ShareLinkWidget::slotDeleteShareFetched()
{
    ...
    _linkShare.clear();
    _ui->enableShareLink->setIcon(QIcon(":/client/resources/add.png"));
    disconnect(_ui->enableShareLink, &QPushButton::clicked, this, &ShareLinkWidget::slotCopyLinkShare);
    connect(_ui->enableShareLink, &QPushButton::clicked, this, &ShareLinkWidget::slotCreateShareLink);
